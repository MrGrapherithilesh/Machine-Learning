...
PROJECT_NAME = 'Retail Sales Forecaster'
PROJECT_SUBTITLE = 'Forecasts monthly retail sales using trend and seasonal features.'
ACCENT = '#FF9F0A'
...
def build_sales_data():
    ...
    sales = 42000 + months * 950 + season * 5200 + rng.normal(0, 900, len(months))
