...
PROJECT_ID = 1039
PROJECT_TITLE = 'Smart City Forecast Accuracy Feature Compression Lab'
PROJECT_INDUSTRY = 'smart city'
PROJECT_SUBJECT = 'forecast accuracy'
PROJECT_KIND = 'dimension_reduction'
