...
PROJECT_ID = 978
PROJECT_TITLE = 'College Campus Portfolio Balance Ensemble Scoring Model'
PROJECT_INDUSTRY = 'college campus'
PROJECT_SUBJECT = 'portfolio balance'
PROJECT_KIND = 'ensemble_scoring'
