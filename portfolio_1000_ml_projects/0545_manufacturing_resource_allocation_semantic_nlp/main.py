...
PROJECT_ID = 545
PROJECT_TITLE = 'Manufacturing Resource Allocation Semantic NLP Matcher'
PROJECT_INDUSTRY = 'manufacturing'
PROJECT_SUBJECT = 'resource allocation'
PROJECT_KIND = 'semantic_nlp'
