...
PROJECT_ID = 1040
PROJECT_TITLE = 'Supply Chain Complaint Routing Model Monitoring Report'
PROJECT_INDUSTRY = 'supply chain'
PROJECT_SUBJECT = 'complaint routing'
PROJECT_KIND = 'model_monitoring'
