...
PROJECT_ID = 321
PROJECT_TITLE = 'Healthcare Marketing Reach Advanced Classifier'
PROJECT_INDUSTRY = 'healthcare'
PROJECT_SUBJECT = 'marketing reach'
PROJECT_KIND = 'advanced_classification'
