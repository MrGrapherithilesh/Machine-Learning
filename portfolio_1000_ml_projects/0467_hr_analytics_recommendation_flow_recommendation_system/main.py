...
PROJECT_ID = 467
PROJECT_TITLE = 'Hr Analytics Recommendation Flow Recommendation System'
PROJECT_INDUSTRY = 'hr analytics'
PROJECT_SUBJECT = 'recommendation flow'
PROJECT_KIND = 'recommendation_system'
